...
public interface PFNGLVERTEXATTRIB4NUBPROC {
    ...
    static MemoryAddress allocate(PFNGLVERTEXATTRIB4NUBPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIB4NUBPROC.class, fi, constants$224.PFNGLVERTEXATTRIB4NUBPROC$FUNC, "(IBBBB)V");
    }
    static MemoryAddress allocate(PFNGLVERTEXATTRIB4NUBPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIB4NUBPROC.class, fi, constants$224.PFNGLVERTEXATTRIB4NUBPROC$FUNC, "(IBBBB)V", scope);
    }
    static PFNGLVERTEXATTRIB4NUBPROC ofAddress(MemoryAddress addr) {
        return (int x0, byte x1, byte x2, byte x3, byte x4) -> {
            try {
                constants$224.PFNGLVERTEXATTRIB4NUBPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
