...
public interface PFNGLCOPYTEXSUBIMAGE1DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCOPYTEXSUBIMAGE1DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOPYTEXSUBIMAGE1DEXTPROC.class, fi, constants$617.PFNGLCOPYTEXSUBIMAGE1DEXTPROC$FUNC, "(IIIIII)V");
    }
    static MemoryAddress allocate(PFNGLCOPYTEXSUBIMAGE1DEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOPYTEXSUBIMAGE1DEXTPROC.class, fi, constants$617.PFNGLCOPYTEXSUBIMAGE1DEXTPROC$FUNC, "(IIIIII)V", scope);
    }
    static PFNGLCOPYTEXSUBIMAGE1DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5) -> {
            try {
                constants$617.PFNGLCOPYTEXSUBIMAGE1DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5);
            } catch (Throwable ex$) {
