...
public interface PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC.class, fi, constants$677.PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC$FUNC, "(IIIFFFF)V");
    }
    static MemoryAddress allocate(PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC.class, fi, constants$677.PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC$FUNC, "(IIIFFFF)V", scope);
    }
    static PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, float x3, float x4, float x5, float x6) -> {
            try {
                constants$677.PFNGLNAMEDPROGRAMLOCALPARAMETER4FEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
