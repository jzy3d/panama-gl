...
public interface PFNGLUNIFORM4IPROC {
    ...
    static MemoryAddress allocate(PFNGLUNIFORM4IPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM4IPROC.class, fi, constants$213.PFNGLUNIFORM4IPROC$FUNC, "(IIIII)V");
    }
    static MemoryAddress allocate(PFNGLUNIFORM4IPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM4IPROC.class, fi, constants$213.PFNGLUNIFORM4IPROC$FUNC, "(IIIII)V", scope);
    }
    static PFNGLUNIFORM4IPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4) -> {
            try {
                constants$213.PFNGLUNIFORM4IPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
