...
public interface PFNGLPATHGLYPHRANGENVPROC {
    ...
    static MemoryAddress allocate(PFNGLPATHGLYPHRANGENVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLPATHGLYPHRANGENVPROC.class, fi, constants$874.PFNGLPATHGLYPHRANGENVPROC$FUNC, "(IILjdk/incubator/foreign/MemoryAddress;IIIIIF)V");
    }
    static MemoryAddress allocate(PFNGLPATHGLYPHRANGENVPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLPATHGLYPHRANGENVPROC.class, fi, constants$874.PFNGLPATHGLYPHRANGENVPROC$FUNC, "(IILjdk/incubator/foreign/MemoryAddress;IIIIIF)V", scope);
    }
    static PFNGLPATHGLYPHRANGENVPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, jdk.incubator.foreign.MemoryAddress x2, int x3, int x4, int x5, int x6, int x7, float x8) -> {
            try {
                constants$874.PFNGLPATHGLYPHRANGENVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8);
            } catch (Throwable ex$) {
