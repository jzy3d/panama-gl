...
public interface PFNGLTEXSUBIMAGE1DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLTEXSUBIMAGE1DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLTEXSUBIMAGE1DEXTPROC.class, fi, constants$751.PFNGLTEXSUBIMAGE1DEXTPROC$FUNC, "(IIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLTEXSUBIMAGE1DEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLTEXSUBIMAGE1DEXTPROC.class, fi, constants$751.PFNGLTEXSUBIMAGE1DEXTPROC$FUNC, "(IIIIIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLTEXSUBIMAGE1DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                constants$751.PFNGLTEXSUBIMAGE1DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
