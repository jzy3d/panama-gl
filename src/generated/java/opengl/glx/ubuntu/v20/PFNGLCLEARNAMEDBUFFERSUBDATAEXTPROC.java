...
public interface PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC.class, fi, constants$694.PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC$FUNC, "(IIJJIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC.class, fi, constants$694.PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC$FUNC, "(IIJJIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, long x2, long x3, int x4, int x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                constants$694.PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
