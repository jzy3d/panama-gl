...
public interface PFNGLVERTEXATTRIBL3DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLVERTEXATTRIBL3DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIBL3DEXTPROC.class, fi, constants$764.PFNGLVERTEXATTRIBL3DEXTPROC$FUNC, "(IDDD)V");
    }
    static MemoryAddress allocate(PFNGLVERTEXATTRIBL3DEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIBL3DEXTPROC.class, fi, constants$764.PFNGLVERTEXATTRIBL3DEXTPROC$FUNC, "(IDDD)V", scope);
    }
    static PFNGLVERTEXATTRIBL3DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, double x1, double x2, double x3) -> {
            try {
                constants$764.PFNGLVERTEXATTRIBL3DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3);
            } catch (Throwable ex$) {
