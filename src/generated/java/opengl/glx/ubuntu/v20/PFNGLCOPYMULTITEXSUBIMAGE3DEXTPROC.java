...
public interface PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC.class, fi, constants$645.PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC$FUNC, "(IIIIIIIIII)V");
    }
    static MemoryAddress allocate(PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC.class, fi, constants$645.PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC$FUNC, "(IIIIIIIIII)V", scope);
    }
    static PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8, int x9) -> {
            try {
                constants$645.PFNGLCOPYMULTITEXSUBIMAGE3DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9);
            } catch (Throwable ex$) {
