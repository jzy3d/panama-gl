...
public interface PFNGLPRESENTFRAMEDUALFILLNVPROC {
    ...
    static MemoryAddress allocate(PFNGLPRESENTFRAMEDUALFILLNVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLPRESENTFRAMEDUALFILLNVPROC.class, fi, constants$894.PFNGLPRESENTFRAMEDUALFILLNVPROC$FUNC, "(IJIIIIIIIIIII)V");
    }
    static MemoryAddress allocate(PFNGLPRESENTFRAMEDUALFILLNVPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLPRESENTFRAMEDUALFILLNVPROC.class, fi, constants$894.PFNGLPRESENTFRAMEDUALFILLNVPROC$FUNC, "(IJIIIIIIIIIII)V", scope);
    }
    static PFNGLPRESENTFRAMEDUALFILLNVPROC ofAddress(MemoryAddress addr) {
        return (int x0, long x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8, int x9, int x10, int x11, int x12) -> {
            try {
                constants$894.PFNGLPRESENTFRAMEDUALFILLNVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12);
            } catch (Throwable ex$) {
