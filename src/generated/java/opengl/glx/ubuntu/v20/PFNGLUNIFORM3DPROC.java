...
public interface PFNGLUNIFORM3DPROC {
    ...
    static MemoryAddress allocate(PFNGLUNIFORM3DPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM3DPROC.class, fi, constants$292.PFNGLUNIFORM3DPROC$FUNC, "(IDDD)V");
    }
    static MemoryAddress allocate(PFNGLUNIFORM3DPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM3DPROC.class, fi, constants$292.PFNGLUNIFORM3DPROC$FUNC, "(IDDD)V", scope);
    }
    static PFNGLUNIFORM3DPROC ofAddress(MemoryAddress addr) {
        return (int x0, double x1, double x2, double x3) -> {
            try {
                constants$292.PFNGLUNIFORM3DPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3);
            } catch (Throwable ex$) {
