...
public interface PFNGLTEXPAGECOMMITMENTARBPROC {
    ...
    static MemoryAddress allocate(PFNGLTEXPAGECOMMITMENTARBPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLTEXPAGECOMMITMENTARBPROC.class, fi, constants$459.PFNGLTEXPAGECOMMITMENTARBPROC$FUNC, "(IIIIIIIIB)V");
    }
    static MemoryAddress allocate(PFNGLTEXPAGECOMMITMENTARBPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLTEXPAGECOMMITMENTARBPROC.class, fi, constants$459.PFNGLTEXPAGECOMMITMENTARBPROC$FUNC, "(IIIIIIIIB)V", scope);
    }
    static PFNGLTEXPAGECOMMITMENTARBPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, byte x8) -> {
            try {
                constants$459.PFNGLTEXPAGECOMMITMENTARBPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8);
            } catch (Throwable ex$) {
