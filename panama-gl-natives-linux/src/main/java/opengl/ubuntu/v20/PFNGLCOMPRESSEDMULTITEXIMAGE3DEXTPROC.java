...
public interface PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC.class, fi, constants$566.PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC$FUNC, "(IIIIIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC.class, fi, constants$566.PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC$FUNC, "(IIIIIIIIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8, jdk.incubator.foreign.MemoryAddress x9) -> {
            try {
                constants$566.PFNGLCOMPRESSEDMULTITEXIMAGE3DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9);
            } catch (Throwable ex$) {
