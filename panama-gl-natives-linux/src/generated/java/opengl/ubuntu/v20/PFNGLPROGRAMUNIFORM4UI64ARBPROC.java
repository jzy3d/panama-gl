...
public interface PFNGLPROGRAMUNIFORM4UI64ARBPROC {
    ...
    static MemoryAddress allocate(PFNGLPROGRAMUNIFORM4UI64ARBPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLPROGRAMUNIFORM4UI64ARBPROC.class, fi, constants$341.PFNGLPROGRAMUNIFORM4UI64ARBPROC$FUNC, "(IIJJJJ)V");
    }
    static MemoryAddress allocate(PFNGLPROGRAMUNIFORM4UI64ARBPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLPROGRAMUNIFORM4UI64ARBPROC.class, fi, constants$341.PFNGLPROGRAMUNIFORM4UI64ARBPROC$FUNC, "(IIJJJJ)V", scope);
    }
    static PFNGLPROGRAMUNIFORM4UI64ARBPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, long x2, long x3, long x4, long x5) -> {
            try {
                constants$341.PFNGLPROGRAMUNIFORM4UI64ARBPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5);
            } catch (Throwable ex$) {
