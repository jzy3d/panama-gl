...
public interface PFNGLVERTEXATTRIB4SNVPROC {
    ...
    static MemoryAddress allocate(PFNGLVERTEXATTRIB4SNVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIB4SNVPROC.class, fi, constants$865.PFNGLVERTEXATTRIB4SNVPROC$FUNC, "(ISSSS)V");
    }
    static MemoryAddress allocate(PFNGLVERTEXATTRIB4SNVPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIB4SNVPROC.class, fi, constants$865.PFNGLVERTEXATTRIB4SNVPROC$FUNC, "(ISSSS)V", scope);
    }
    static PFNGLVERTEXATTRIB4SNVPROC ofAddress(MemoryAddress addr) {
        return (int x0, short x1, short x2, short x3, short x4) -> {
            try {
                constants$865.PFNGLVERTEXATTRIB4SNVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
