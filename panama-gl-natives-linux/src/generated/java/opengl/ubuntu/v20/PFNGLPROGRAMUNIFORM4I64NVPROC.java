...
public interface PFNGLPROGRAMUNIFORM4I64NVPROC {
    ...
    static MemoryAddress allocate(PFNGLPROGRAMUNIFORM4I64NVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLPROGRAMUNIFORM4I64NVPROC.class, fi, constants$462.PFNGLPROGRAMUNIFORM4I64NVPROC$FUNC, "(IIJJJJ)V");
    }
    static MemoryAddress allocate(PFNGLPROGRAMUNIFORM4I64NVPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLPROGRAMUNIFORM4I64NVPROC.class, fi, constants$462.PFNGLPROGRAMUNIFORM4I64NVPROC$FUNC, "(IIJJJJ)V", scope);
    }
    static PFNGLPROGRAMUNIFORM4I64NVPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, long x2, long x3, long x4, long x5) -> {
            try {
                constants$462.PFNGLPROGRAMUNIFORM4I64NVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5);
            } catch (Throwable ex$) {
