...
public interface PFNGLUNIFORM4UI64ARBPROC {
    ...
    static MemoryAddress allocate(PFNGLUNIFORM4UI64ARBPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM4UI64ARBPROC.class, fi, constants$420.PFNGLUNIFORM4UI64ARBPROC$FUNC, "(IJJJJ)V");
    }
    static MemoryAddress allocate(PFNGLUNIFORM4UI64ARBPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM4UI64ARBPROC.class, fi, constants$420.PFNGLUNIFORM4UI64ARBPROC$FUNC, "(IJJJJ)V", scope);
    }
    static PFNGLUNIFORM4UI64ARBPROC ofAddress(MemoryAddress addr) {
        return (int x0, long x1, long x2, long x3, long x4) -> {
            try {
                constants$420.PFNGLUNIFORM4UI64ARBPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
