...
public interface PFNGLCOLOR4HNVPROC {
    ...
    static MemoryAddress allocate(PFNGLCOLOR4HNVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOLOR4HNVPROC.class, fi, constants$852.PFNGLCOLOR4HNVPROC$FUNC, "(SSSS)V");
    }
    static MemoryAddress allocate(PFNGLCOLOR4HNVPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOLOR4HNVPROC.class, fi, constants$852.PFNGLCOLOR4HNVPROC$FUNC, "(SSSS)V", scope);
    }
    static PFNGLCOLOR4HNVPROC ofAddress(MemoryAddress addr) {
        return (short x0, short x1, short x2, short x3) -> {
            try {
                constants$852.PFNGLCOLOR4HNVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3);
            } catch (Throwable ex$) {
