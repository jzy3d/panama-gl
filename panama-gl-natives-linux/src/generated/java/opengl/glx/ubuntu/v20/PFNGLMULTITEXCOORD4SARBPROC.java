...
public interface PFNGLMULTITEXCOORD4SARBPROC {
    ...
    static MemoryAddress allocate(PFNGLMULTITEXCOORD4SARBPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLMULTITEXCOORD4SARBPROC.class, fi, constants$176.PFNGLMULTITEXCOORD4SARBPROC$FUNC, "(ISSSS)V");
    }
    static MemoryAddress allocate(PFNGLMULTITEXCOORD4SARBPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLMULTITEXCOORD4SARBPROC.class, fi, constants$176.PFNGLMULTITEXCOORD4SARBPROC$FUNC, "(ISSSS)V", scope);
    }
    static PFNGLMULTITEXCOORD4SARBPROC ofAddress(MemoryAddress addr) {
        return (int x0, short x1, short x2, short x3, short x4) -> {
            try {
                constants$176.PFNGLMULTITEXCOORD4SARBPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
