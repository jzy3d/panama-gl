...
public interface PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC {
    ...
    static MemoryAddress allocate(PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC.class, fi, constants$159.PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC$FUNC, "(IIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC.class, fi, constants$159.PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC$FUNC, "(IIIIIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                constants$159.PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
