...
public interface PFNGLTEXSTORAGEMEM2DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLTEXSTORAGEMEM2DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLTEXSTORAGEMEM2DEXTPROC.class, fi, constants$728.PFNGLTEXSTORAGEMEM2DEXTPROC$FUNC, "(IIIIIIJ)V");
    }
    static MemoryAddress allocate(PFNGLTEXSTORAGEMEM2DEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLTEXSTORAGEMEM2DEXTPROC.class, fi, constants$728.PFNGLTEXSTORAGEMEM2DEXTPROC$FUNC, "(IIIIIIJ)V", scope);
    }
    static PFNGLTEXSTORAGEMEM2DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, long x6) -> {
            try {
                constants$728.PFNGLTEXSTORAGEMEM2DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
