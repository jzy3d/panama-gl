...
public interface PFNGLMAPVERTEXATTRIB2DAPPLEPROC {
    ...
    static MemoryAddress allocate(PFNGLMAPVERTEXATTRIB2DAPPLEPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLMAPVERTEXATTRIB2DAPPLEPROC.class, fi, constants$571.PFNGLMAPVERTEXATTRIB2DAPPLEPROC$FUNC, "(IIDDIIDDIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLMAPVERTEXATTRIB2DAPPLEPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLMAPVERTEXATTRIB2DAPPLEPROC.class, fi, constants$571.PFNGLMAPVERTEXATTRIB2DAPPLEPROC$FUNC, "(IIDDIIDDIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLMAPVERTEXATTRIB2DAPPLEPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, double x2, double x3, int x4, int x5, double x6, double x7, int x8, int x9, jdk.incubator.foreign.MemoryAddress x10) -> {
            try {
                constants$571.PFNGLMAPVERTEXATTRIB2DAPPLEPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10);
            } catch (Throwable ex$) {
