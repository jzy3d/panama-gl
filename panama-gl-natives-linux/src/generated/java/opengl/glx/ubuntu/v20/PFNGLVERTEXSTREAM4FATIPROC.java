...
public interface PFNGLVERTEXSTREAM4FATIPROC {
    ...
    static MemoryAddress allocate(PFNGLVERTEXSTREAM4FATIPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXSTREAM4FATIPROC.class, fi, constants$595.PFNGLVERTEXSTREAM4FATIPROC$FUNC, "(IFFFF)V");
    }
    static MemoryAddress allocate(PFNGLVERTEXSTREAM4FATIPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXSTREAM4FATIPROC.class, fi, constants$595.PFNGLVERTEXSTREAM4FATIPROC$FUNC, "(IFFFF)V", scope);
    }
    static PFNGLVERTEXSTREAM4FATIPROC ofAddress(MemoryAddress addr) {
        return (int x0, float x1, float x2, float x3, float x4) -> {
            try {
                constants$595.PFNGLVERTEXSTREAM4FATIPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
