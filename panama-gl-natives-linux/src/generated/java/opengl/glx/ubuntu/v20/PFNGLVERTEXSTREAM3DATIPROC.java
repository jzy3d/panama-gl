...
public interface PFNGLVERTEXSTREAM3DATIPROC {
    ...
    static MemoryAddress allocate(PFNGLVERTEXSTREAM3DATIPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXSTREAM3DATIPROC.class, fi, constants$593.PFNGLVERTEXSTREAM3DATIPROC$FUNC, "(IDDD)V");
    }
    static MemoryAddress allocate(PFNGLVERTEXSTREAM3DATIPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXSTREAM3DATIPROC.class, fi, constants$593.PFNGLVERTEXSTREAM3DATIPROC$FUNC, "(IDDD)V", scope);
    }
    static PFNGLVERTEXSTREAM3DATIPROC ofAddress(MemoryAddress addr) {
        return (int x0, double x1, double x2, double x3) -> {
            try {
                constants$593.PFNGLVERTEXSTREAM3DATIPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3);
            } catch (Throwable ex$) {
