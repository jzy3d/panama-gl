...
public interface PFNGLVERTEXATTRIB3SPROC {
    ...
    static MemoryAddress allocate(PFNGLVERTEXATTRIB3SPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIB3SPROC.class, fi, constants$222.PFNGLVERTEXATTRIB3SPROC$FUNC, "(ISSS)V");
    }
    static MemoryAddress allocate(PFNGLVERTEXATTRIB3SPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXATTRIB3SPROC.class, fi, constants$222.PFNGLVERTEXATTRIB3SPROC$FUNC, "(ISSS)V", scope);
    }
    static PFNGLVERTEXATTRIB3SPROC ofAddress(MemoryAddress addr) {
        return (int x0, short x1, short x2, short x3) -> {
            try {
                constants$222.PFNGLVERTEXATTRIB3SPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3);
            } catch (Throwable ex$) {
