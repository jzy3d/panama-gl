...
public interface PFNGLCOMPRESSEDTEXIMAGE3DARBPROC {
    ...
    static MemoryAddress allocate(PFNGLCOMPRESSEDTEXIMAGE3DARBPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDTEXIMAGE3DARBPROC.class, fi, constants$459.PFNGLCOMPRESSEDTEXIMAGE3DARBPROC$FUNC, "(IIIIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLCOMPRESSEDTEXIMAGE3DARBPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDTEXIMAGE3DARBPROC.class, fi, constants$459.PFNGLCOMPRESSEDTEXIMAGE3DARBPROC$FUNC, "(IIIIIIIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLCOMPRESSEDTEXIMAGE3DARBPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, jdk.incubator.foreign.MemoryAddress x8) -> {
            try {
                constants$459.PFNGLCOMPRESSEDTEXIMAGE3DARBPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8);
            } catch (Throwable ex$) {
