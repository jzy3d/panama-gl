...
public interface PFNGLUNIFORM4UI64NVPROC {
    ...
    static MemoryAddress allocate(PFNGLUNIFORM4UI64NVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM4UI64NVPROC.class, fi, constants$544.PFNGLUNIFORM4UI64NVPROC$FUNC, "(IJJJJ)V");
    }
    static MemoryAddress allocate(PFNGLUNIFORM4UI64NVPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM4UI64NVPROC.class, fi, constants$544.PFNGLUNIFORM4UI64NVPROC$FUNC, "(IJJJJ)V", scope);
    }
    static PFNGLUNIFORM4UI64NVPROC ofAddress(MemoryAddress addr) {
        return (int x0, long x1, long x2, long x3, long x4) -> {
            try {
                constants$544.PFNGLUNIFORM4UI64NVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
