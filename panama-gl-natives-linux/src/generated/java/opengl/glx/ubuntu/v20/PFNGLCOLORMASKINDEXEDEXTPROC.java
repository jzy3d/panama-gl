...
public interface PFNGLCOLORMASKINDEXEDEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCOLORMASKINDEXEDEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOLORMASKINDEXEDEXTPROC.class, fi, constants$706.PFNGLCOLORMASKINDEXEDEXTPROC$FUNC, "(IBBBB)V");
    }
    static MemoryAddress allocate(PFNGLCOLORMASKINDEXEDEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOLORMASKINDEXEDEXTPROC.class, fi, constants$706.PFNGLCOLORMASKINDEXEDEXTPROC$FUNC, "(IBBBB)V", scope);
    }
    static PFNGLCOLORMASKINDEXEDEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, byte x1, byte x2, byte x3, byte x4) -> {
            try {
                constants$706.PFNGLCOLORMASKINDEXEDEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
