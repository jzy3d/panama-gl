...
public interface PFNGLCLEARTEXSUBIMAGEPROC {
    ...
    static MemoryAddress allocate(PFNGLCLEARTEXSUBIMAGEPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCLEARTEXSUBIMAGEPROC.class, fi, constants$353.PFNGLCLEARTEXSUBIMAGEPROC$FUNC, "(IIIIIIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLCLEARTEXSUBIMAGEPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCLEARTEXSUBIMAGEPROC.class, fi, constants$353.PFNGLCLEARTEXSUBIMAGEPROC$FUNC, "(IIIIIIIIIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLCLEARTEXSUBIMAGEPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8, int x9, jdk.incubator.foreign.MemoryAddress x10) -> {
            try {
                constants$353.PFNGLCLEARTEXSUBIMAGEPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10);
            } catch (Throwable ex$) {
