...
public interface PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC {
    ...
    static MemoryAddress allocate(PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC.class, fi, constants$630.PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC$FUNC, "(IIIIIII)V");
    }
    static MemoryAddress allocate(PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC.class, fi, constants$630.PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC$FUNC, "(IIIIIII)V", scope);
    }
    static PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6) -> {
            try {
                constants$630.PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
