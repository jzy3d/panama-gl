...
public interface PFNGLREADNPIXELSARBPROC {
    ...
    static MemoryAddress allocate(PFNGLREADNPIXELSARBPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLREADNPIXELSARBPROC.class, fi, constants$435.PFNGLREADNPIXELSARBPROC$FUNC, "(IIIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLREADNPIXELSARBPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLREADNPIXELSARBPROC.class, fi, constants$435.PFNGLREADNPIXELSARBPROC$FUNC, "(IIIIIIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLREADNPIXELSARBPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, jdk.incubator.foreign.MemoryAddress x7) -> {
            try {
                constants$435.PFNGLREADNPIXELSARBPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7);
            } catch (Throwable ex$) {
