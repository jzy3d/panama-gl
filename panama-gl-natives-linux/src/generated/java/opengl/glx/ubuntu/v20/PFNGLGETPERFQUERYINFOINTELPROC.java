...
public interface PFNGLGETPERFQUERYINFOINTELPROC {
    ...
    static MemoryAddress allocate(PFNGLGETPERFQUERYINFOINTELPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLGETPERFQUERYINFOINTELPROC.class, fi, constants$796.PFNGLGETPERFQUERYINFOINTELPROC$FUNC, "(IILjdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLGETPERFQUERYINFOINTELPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLGETPERFQUERYINFOINTELPROC.class, fi, constants$796.PFNGLGETPERFQUERYINFOINTELPROC$FUNC, "(IILjdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLGETPERFQUERYINFOINTELPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, jdk.incubator.foreign.MemoryAddress x2, jdk.incubator.foreign.MemoryAddress x3, jdk.incubator.foreign.MemoryAddress x4, jdk.incubator.foreign.MemoryAddress x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                constants$796.PFNGLGETPERFQUERYINFOINTELPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
