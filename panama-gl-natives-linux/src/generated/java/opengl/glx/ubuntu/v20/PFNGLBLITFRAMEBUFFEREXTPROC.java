...
public interface PFNGLBLITFRAMEBUFFEREXTPROC {
    ...
    static MemoryAddress allocate(PFNGLBLITFRAMEBUFFEREXTPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLBLITFRAMEBUFFEREXTPROC.class, fi, constants$710.PFNGLBLITFRAMEBUFFEREXTPROC$FUNC, "(IIIIIIIIII)V");
    }
    static MemoryAddress allocate(PFNGLBLITFRAMEBUFFEREXTPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLBLITFRAMEBUFFEREXTPROC.class, fi, constants$710.PFNGLBLITFRAMEBUFFEREXTPROC$FUNC, "(IIIIIIIIII)V", scope);
    }
    static PFNGLBLITFRAMEBUFFEREXTPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8, int x9) -> {
            try {
                constants$710.PFNGLBLITFRAMEBUFFEREXTPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8, x9);
            } catch (Throwable ex$) {
