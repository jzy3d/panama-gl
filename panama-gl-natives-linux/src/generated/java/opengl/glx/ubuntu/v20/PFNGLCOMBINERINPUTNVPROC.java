...
public interface PFNGLCOMBINERINPUTNVPROC {
    ...
    static MemoryAddress allocate(PFNGLCOMBINERINPUTNVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOMBINERINPUTNVPROC.class, fi, constants$899.PFNGLCOMBINERINPUTNVPROC$FUNC, "(IIIIII)V");
    }
    static MemoryAddress allocate(PFNGLCOMBINERINPUTNVPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOMBINERINPUTNVPROC.class, fi, constants$899.PFNGLCOMBINERINPUTNVPROC$FUNC, "(IIIIII)V", scope);
    }
    static PFNGLCOMBINERINPUTNVPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5) -> {
            try {
                constants$899.PFNGLCOMBINERINPUTNVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5);
            } catch (Throwable ex$) {
