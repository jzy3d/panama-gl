...
public interface PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC {
    ...
    static MemoryAddress allocate(PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC.class, fi, constants$158.PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC$FUNC, "(IIIIIIIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC.class, fi, constants$158.PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC$FUNC, "(IIIIIIIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, jdk.incubator.foreign.MemoryAddress x8) -> {
            try {
                constants$158.PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6, x7, x8);
            } catch (Throwable ex$) {
