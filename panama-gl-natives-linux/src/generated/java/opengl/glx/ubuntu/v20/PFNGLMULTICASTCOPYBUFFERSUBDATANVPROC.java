...
public interface PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC {
    ...
    static MemoryAddress allocate(PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC.class, fi, constants$840.PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC$FUNC, "(IIIIJJJ)V");
    }
    static MemoryAddress allocate(PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC.class, fi, constants$840.PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC$FUNC, "(IIIIJJJ)V", scope);
    }
    static PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, long x4, long x5, long x6) -> {
            try {
                constants$840.PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
