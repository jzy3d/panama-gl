...
class constants$206 {
    ...
    static final MethodHandle PFNGLGETSHADERINFOLOGPROC$MH = RuntimeHelper.downcallHandle(
        ...
        constants$206.PFNGLGETSHADERINFOLOGPROC$FUNC, false
    );
    ...
    static final MethodHandle PFNGLGETSHADERSOURCEPROC$MH = RuntimeHelper.downcallHandle(
        "(IILjdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V",
        constants$206.PFNGLGETSHADERSOURCEPROC$FUNC, false
    );
    ...
    static final MethodHandle PFNGLGETUNIFORMLOCATIONPROC$MH = RuntimeHelper.downcallHandle(
        ...
        constants$206.PFNGLGETUNIFORMLOCATIONPROC$FUNC, false
    );
}
