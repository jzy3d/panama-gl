...
class constants$702 {
    ...
    static final MethodHandle PFNGLTEXTURESTORAGE2DEXTPROC$MH = RuntimeHelper.downcallHandle(
        "(IIIIII)V",
        constants$702.PFNGLTEXTURESTORAGE2DEXTPROC$FUNC, false
    );
    ...
    static final MethodHandle PFNGLTEXTURESTORAGE3DEXTPROC$MH = RuntimeHelper.downcallHandle(
        "(IIIIIII)V",
        constants$702.PFNGLTEXTURESTORAGE3DEXTPROC$FUNC, false
    );
    ...
    static final MethodHandle PFNGLTEXTURESTORAGE2DMULTISAMPLEEXTPROC$MH = RuntimeHelper.downcallHandle(
        "(IIIIIIB)V",
        constants$702.PFNGLTEXTURESTORAGE2DMULTISAMPLEEXTPROC$FUNC, false
    );
}
