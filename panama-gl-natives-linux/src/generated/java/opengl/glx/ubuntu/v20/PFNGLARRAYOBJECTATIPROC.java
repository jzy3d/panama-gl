...
public interface PFNGLARRAYOBJECTATIPROC {
    ...
    static MemoryAddress allocate(PFNGLARRAYOBJECTATIPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLARRAYOBJECTATIPROC.class, fi, constants$583.PFNGLARRAYOBJECTATIPROC$FUNC, "(IIIIII)V");
    }
    static MemoryAddress allocate(PFNGLARRAYOBJECTATIPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLARRAYOBJECTATIPROC.class, fi, constants$583.PFNGLARRAYOBJECTATIPROC$FUNC, "(IIIIII)V", scope);
    }
    static PFNGLARRAYOBJECTATIPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, int x3, int x4, int x5) -> {
            try {
                constants$583.PFNGLARRAYOBJECTATIPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5);
            } catch (Throwable ex$) {
