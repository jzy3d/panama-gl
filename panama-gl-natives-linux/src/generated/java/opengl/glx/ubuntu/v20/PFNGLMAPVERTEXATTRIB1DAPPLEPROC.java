...
public interface PFNGLMAPVERTEXATTRIB1DAPPLEPROC {
    ...
    static MemoryAddress allocate(PFNGLMAPVERTEXATTRIB1DAPPLEPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLMAPVERTEXATTRIB1DAPPLEPROC.class, fi, constants$570.PFNGLMAPVERTEXATTRIB1DAPPLEPROC$FUNC, "(IIDDIILjdk/incubator/foreign/MemoryAddress;)V");
    }
    static MemoryAddress allocate(PFNGLMAPVERTEXATTRIB1DAPPLEPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLMAPVERTEXATTRIB1DAPPLEPROC.class, fi, constants$570.PFNGLMAPVERTEXATTRIB1DAPPLEPROC$FUNC, "(IIDDIILjdk/incubator/foreign/MemoryAddress;)V", scope);
    }
    static PFNGLMAPVERTEXATTRIB1DAPPLEPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, double x2, double x3, int x4, int x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                constants$570.PFNGLMAPVERTEXATTRIB1DAPPLEPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
