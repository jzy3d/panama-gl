...
public interface PFNGLBINDBUFFERRANGEPROC {
    ...
    static MemoryAddress allocate(PFNGLBINDBUFFERRANGEPROC fi) {
        return RuntimeHelper.upcallStub(PFNGLBINDBUFFERRANGEPROC.class, fi, constants$234.PFNGLBINDBUFFERRANGEPROC$FUNC, "(IIIJJ)V");
    }
    static MemoryAddress allocate(PFNGLBINDBUFFERRANGEPROC fi, ResourceScope scope) {
        return RuntimeHelper.upcallStub(PFNGLBINDBUFFERRANGEPROC.class, fi, constants$234.PFNGLBINDBUFFERRANGEPROC$FUNC, "(IIIJJ)V", scope);
    }
    static PFNGLBINDBUFFERRANGEPROC ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, long x3, long x4) -> {
            try {
                constants$234.PFNGLBINDBUFFERRANGEPROC$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
