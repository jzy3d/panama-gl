...
public class JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE {
    ...
    public static MemoryAddress VolumeName$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE.VolumeName$VH.get(seg);
    }
    ...
    public static MemoryAddress VolumeName$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE.VolumeName$VH.get(seg.asSlice(index*sizeof()));
    }
