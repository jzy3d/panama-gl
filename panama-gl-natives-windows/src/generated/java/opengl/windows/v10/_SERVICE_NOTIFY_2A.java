...
public class _SERVICE_NOTIFY_2A {
    ...
    public static MemoryAddress pfnNotifyCallback$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFY_2A.pfnNotifyCallback$VH.get(seg);
    }
    ...
    public static MemoryAddress pfnNotifyCallback$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFY_2A.pfnNotifyCallback$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pContext$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFY_2A.pContext$VH.get(seg);
    }
    ...
    public static MemoryAddress pContext$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFY_2A.pContext$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pszServiceNames$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFY_2A.pszServiceNames$VH.get(seg);
    }
    ...
    public static MemoryAddress pszServiceNames$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)_SERVICE_NOTIFY_2A.pszServiceNames$VH.get(seg.asSlice(index*sizeof()));
    }
